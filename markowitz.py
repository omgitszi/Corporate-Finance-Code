...
if __name__ == "__main__":
    cov_matrix, mu = compute_annualized_covariance()
    ...
    out_img = Path(__file__).resolve().parent / "efficient_frontier.png"
    ...
    weights_out = Path(__file__).resolve().parent / "weights_comparison.png"
